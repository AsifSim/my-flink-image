...
public final class LocalEnvironmentEntrypoint {
  ...
  private static void parseModuleOption(
      MultipleParameterTool parameterTool, Configuration flinkConfiguration) {
//    final String module = parameterTool.get(MODULE_OPTION, "src/main/resources/module.yaml");
    final String module = parameterTool.get(MODULE_OPTION, "file:///app/module.yaml");
